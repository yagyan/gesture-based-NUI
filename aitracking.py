...
while True:
    ...
    if len(lmList) != 0:
        ...
        if flag == "11":
            ...
            if label == dominant and fingers[1] == 1 and fingers[2] == 0 and fingers[3] == 0 and fingers[4] == 0 and \
                    fingers[0] == 1:
            ...
            if label == dominant and fingers[1] == 1 and fingers[2] == 1 and fingers[3] == 0 and fingers[4] == 0 and \
                    fingers[0] == 1:
            ...
            if label != dominant and fingers[0] == 1 and fingers[1] == 1 and fingers[2] == 0 and fingers[3] == 0 and \
                    fingers[4] == 0:
            ...
            if label != dominant and fingers[0] == 1 and fingers[1] == 1 and fingers[2] == 1 and fingers[3] == 0 and \
                    fingers[4] == 0:
                # Filter based on size
                area = (bbox[2] - bbox[0]) * (bbox[3] - bbox[1]) // 100
                # print(area)
                if 250 < area < 1000:
                    length1, img, lineInfo = FD.findDistance(lmList, 4, 12, img)
            ...
            # if label == dominant and fingers[0] == 1 and fingers[1] == 1 and fingers[2] == 1 and fingers[3] == 1 and \
            #         fingers[4] == 1:
